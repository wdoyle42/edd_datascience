...
```{r}
els_train%>%summarize(mean(bynels2m))
...
This finding reflects the basic ineuity in our education system: lower income students score lower on math scores. This holds true even if we control for parental education. 
...
rmse_test_1<-modelr::rmse(mod2,els_test);rmse_test_1
```

Notice that this is higher than the value for our training dataset: our training model doesn't predict out of sample as well as it predicts in sanmple. This is a pattern you'll see again and again. 
